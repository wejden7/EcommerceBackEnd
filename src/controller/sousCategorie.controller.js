...
const {deleteAllSousSousCategorieOfSousCategorie,findSousSousCategorie} =require("../service/sousSousCategorie.service");
...
exports.updateOneSousCategorie = async (req, res, next) => {
  ...
  console.log(req.body)
        ...
        updateOneSousCategorie(condition,data).then(categorie =>{
